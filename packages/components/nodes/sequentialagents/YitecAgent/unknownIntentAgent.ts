...
class UnknownIntentAgent_SeqAgents implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        this.label = 'Unknown Intent Agent'
        this.name = 'unknownIntentAgent'
        this.version = 3.1
        this.type = 'Agent'
...
module.exports = { nodeClass: UnknownIntentAgent_SeqAgents }
